...
This plugin was created because of a problem I've ran into when I was working on a theme then I created a [post on my Blog with a video]() about the problem.

As this is a plugin created just to solve a simple problem it's just a single file Plugin, and it is very very light.
...
3. **Issue Pull Requests:** If you're a developer, the easiest way to get involved is to help out on [issues already reported](https://github.com/bordoni/online-now/issues) in GitHub. Be sure to check out the [contributing guide](https://github.com/iryz/fakerpress/blob/master/contributing.md) for developers.
